          ...
          <KeyboardAvoidingView  
              ...
              <View style={styles2.mainContainer}>
                 <View style={styles2.itemCenter}>
                    <Text style={styles2.titleText}>Forgot Password</Text>
                 </View>
                 {checkdata &&
                 <>
                 {numForCheck == checkdata['numForCheck'] &&
                 <>
                  <Text style={styles2.headingText}>Please reset your password</Text>
                  <TextInput
                    mode='outlined'
                    label='Password'
                 ...
                 {numForCheck != checkdata['numForCheck'] &&
                 <>
                  <Text style={styles2.headingText}>Email for password reset has been already sent! Please check the email we sent to you, and type the number in the following.</Text>
                  <TextInput
                    mode='outlined'
                   ...
                   <View style={[styles2.itemLeft, {marginTop: 5}]}>
